...
public class CustomConfiguredFeatures {
    ...
    private static ConfiguredFeature<?, ?> ORE_GRANODIORITE = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, BlockRegistry.GRANODIORITE.getDefaultState(), 33)).decorate(Decorator.RANGE.configure(new RangeDecoratorConfig(UniformHeightProvider.create(YOffset.fixed(0), YOffset.fixed(200)))).spreadHorizontally().repeat(99));
