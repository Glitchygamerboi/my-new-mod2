...
public static final Block DINOSTATUE = new Block(FabricBlockSettings.copy(Blocks.STONE).requiresTool().strength(1.5F, 6.0F));
...
public static final Block EXAMPLE_BLOCK = new Block(FabricBlockSettings.copy(Blocks.GRANITE).requiresTool().strength(0F, 0F));
    public static void register() {
        ...
        Registry.register(Registry.BLOCK, Utils.ID("dinostatue"), DINOSTATUE);
