...
public class ItemRegistry {
   ...
   //you can reuse the code to add more blocks, make sure to change the names, if you are making an item, replace BlockItem with Item
    ...
    public static final Item PINE_LOG = new BlockItem(BlockRegistry.PINE_LOG, new FabricItemSettings().group(BUItemGroups.REALISTICS_NATURE_BLOCKS));
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, Utils.ID("pine_log"), PINE_LOG);
